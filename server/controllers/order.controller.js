    ...
    try {
        ...
        const newOrder = await orderModel.create({
            product: productList.map((item) => ({
                ...
                delivery_location: [{
                    city,  // Use the actual city from address
                    state,
                }],
            })),
            address: {
        ...
        // If payment method is not Cash on Delivery, create a Stripe session
        if (payment_method !== "Cash on Delivery") {
            ...
            lineItems.push({
                price_data: {
                    ...
                    unit_amount: delivery_charge * 100, // Assuming 50 INR for delivery charges
                },
                quantity: 1,
            });
