...
const Register = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            const res = await axios.post(`${SPACE_STATION_API_END_POINT}/register`, formData, {
                headers: {
                        ...
                        <div className='my-5'>
                            ...
                            <div className='flex items-center justify-between'>
                                <Input 
                                    ...
                                    value={input.password} onChange={changeInputHandler}
                                />
                                {
                                    visible ? (
                        ...
                        <div className='my-5'>
                            ...
                            <div className='flex items-center justify-between'>
                                <Input 
                                    ...
                                    className='w-full p-2 border border-gray-300 rounded-md'
                                    value={input.confirmPassword} onChange={changeInputHandler}
                                />
                                {
                                    confirmVisible ? (
